...
INSERT INTO `__new_entities`("id", "campaign_id", "type", "name", "slug", "summary", "content", "first_session_id", "created_at", "updated_at") SELECT "id", "campaign_id", "type", "name", "slug", "summary", "content", "first_session_id", "created_at", "updated_at" FROM `entities`;--> statement-breakpoint
